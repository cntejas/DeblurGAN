...
os.system(train)
test = "python /content/DeblurGAN/test.py --dataroot /content/DeblurGAN/datasets/test --model test --dataset_mode single --learn_residual --resize_or_crop 'scale_width'"
# Execute the command
os.system(test)
